import person from './assets/juliana.png'
    ...
    <>
      <div className="flex justify-between">
        ...
        <div className="flex flex-col flex-1 bg-white border-20  border-[#3d0707] ">
          <div className="p-[2%]">
            <p className="text-8xl text-[#6d0605] font-bold font-anton leading-[115px]">
              <span>Jully Fest</span>
              <span className="block lg:inline"> 2025</span>
            </p>
            <p className="text-4xl text-[#6d0605] font-poppins font-light">15 ANOS</p>
          </div>

          <div className="flex flex-col lg:flex-row -mt-[4%] p-[5%] lg:p-[4%] h-auto ">

            <div className='bg-[url(./assets/bg.jpeg)] h-[500px] w-[100%] lg:h-auto bg-cover lg:w-[55%] '></div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 bg-[#3d0707] p-[2%]'>
            <div className='text-white'>
              <p className='font-alice text-3xl'>Local:</p>
              <a href="https://maps.app.goo.gl/qZjZrz9zsiVT7ugo6?g_st=aw" target='_blank' className='underline font-bebas text-5xl'>
            ...
            <div className='text-white'>
              ...
              <p className='font-bebas text-5xl'>01.11.2025</p>
            </div>

            <div className='text-white'>
              <p className='font-alice text-3xl'>Hora:</p>
              <p className='font-bebas text-5xl'>19:00 - <br />CREPÚSCULO</p>
            </div>
            ...
            <div className='text-white'>
              ...
              <a href='https://forms.gle/B6jAaGv1zE1iYAuY6' target='_blank' className='font-bebas text-5xl'>
                CONFIRMAÇÃO
              </a>
            </div>
          </div>
